...
########### 13. All marker distribution (FeaturePlot Fig S4A) ########
#### Feature plot ###
...
########### 15. Hallmark functional analysis (Fig S6B) ####
## tcell 
...
########### 16. T cell related functional analysis (Fig S6A) ################
